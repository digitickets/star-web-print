...
var StarWebPrintTrader = function (a) {
    ...
    void 0 != a &&
    (void 0 != a.url && (this.url = a.url), void 0 != a.checkedblock && (this.checkedblock = a.checkedblock), void 0 != a.papertype && (this.papertype = a.papertype), void 0 != a.timeout &&
...
StarWebPrintTrader.prototype.sendMessage = function (a) {
    ...
    void 0 != a.papertype
        ...
        : 'black_mark' == a.papertype
            ...
            : 'black_mark_and_detect_at_power_on' == a.papertype && (b += ' papertype="black_mark_and_detect_at_power_on"')
    ...
    if (-1 != navigator.userAgent.indexOf('iPad;') || -1 != navigator.userAgent.indexOf('iPhone;') || -1 != navigator.userAgent.indexOf('iPod touch;') ||
        -1 != navigator.userAgent.indexOf('Android')) if (-1 == navigator.userAgent.indexOf('WebPRNTSupportHTTPS') &&
        (0 == b.toLowerCase().indexOf('https://localhost') || 0 == b.toLowerCase().indexOf('https://127.0.0.1'))) b = 'http://' + b.substring(8);
    try {c.open('POST', b, !0);} catch (f) {
        if (this.onError) this.onError({status: 10002, responseText: f.message});
        return;
    }
    try {void 0 != a.timeout ? c.timeout = a.timeout : this.timeout && (c.timeout = this.timeout);} catch (h) {}
    ...
    try {c.ontimeout = function () {if (d.onTimeout) d.onTimeout();};} catch (k) {}
    try {c.send(e);} catch (g) {if (this.onError) this.onError({status: 10003, responseText: g.message});}
};
StarWebPrintTrader.prototype.isCoverOpen = function (a) {return parseInt(a.traderStatus.substr(4, 2), 16) & 32 ? !0 : !1;};
StarWebPrintTrader.prototype.isOffLine = function (a) {return parseInt(a.traderStatus.substr(4, 2), 16) & 8 ? !0 : !1;};
StarWebPrintTrader.prototype.isCompulsionSwitchClose = function (a) {return parseInt(a.traderStatus.substr(4, 2), 16) & 4 ? !0 : !1;};
StarWebPrintTrader.prototype.isEtbCommandExecute = function (a) {return parseInt(a.traderStatus.substr(4, 2), 16) & 2 ? !0 : !1;};
StarWebPrintTrader.prototype.isHighTemperatureStop = function (a) {return parseInt(a.traderStatus.substr(6, 2), 16) & 64 ? !0 : !1;};
StarWebPrintTrader.prototype.isNonRecoverableError = function (a) {return parseInt(a.traderStatus.substr(6, 2), 16) & 32 ? !0 : !1;};
StarWebPrintTrader.prototype.isAutoCutterError = function (a) {return parseInt(a.traderStatus.substr(6, 2), 16) & 8 ? !0 : !1;};
StarWebPrintTrader.prototype.isBlackMarkError = function (a) {return parseInt(a.traderStatus.substr(8, 2), 16) & 8 ? !0 : !1;};
StarWebPrintTrader.prototype.isPaperEnd = function (a) {return parseInt(a.traderStatus.substr(10, 2), 16) & 8 ? !0 : !1;};
StarWebPrintTrader.prototype.isPaperNearEnd = function (a) {return parseInt(a.traderStatus.substr(10, 2), 16) & 4 ? !0 : !1;};
