...
StarBarcodeEncoder.prototype.createJAN13 = function (a) {
    ...
    if (b %= 10) b = 10 - b;
    for (var g = '101', h = '0000000 0001011 0001101 0001110 0010011 0011001 0011100 0010101 0010110 0011010'.split(' ')[parseInt(a.charAt(0))], d = 1; 7 > d; d++) g = '0' == h[d] ? g +
        f[parseInt(a.charAt(d))] : g + e[parseInt(a.charAt(d))];
    g += '01010';
...
StarBarcodeEncoder.prototype.createITF = function (a) {
    var f = 'NNWWN WNNNW NWNNW WWNNN NNWNW WNWNN NWWNN NNNWW WNNWN NWNWN'.split(' '), e = 'nnwwn wnnnw nwnnw wwnnn nnwnw wnwnn nwwnn nnnww wnnwn nwnwn'.split(' ');
    a = a.data;
    if (0 == a.length) throw Error('Data length is invalid.');
    if (a.match(/[^0-9]/g)) throw Error('Data is invalid.');
    a.length % 2 && (a = '0' + a);
    for (var c = 'NnNn', b = 0; b < a.length; b += 2) var d = f[parseInt(a.charAt(b))], g = e[parseInt(a.charAt(b + 1))], c = c + d.charAt(0), c = c + g.charAt(0), c = c + d.charAt(1), c = c +
        g.charAt(1),
