...
StarWebPrintBuilder.prototype.createFeedElement = function (b) {
    var a;
    if (void 0 != b) if (void 0 != b.line || void 0 != b.unit) a = '<feed' + this._analysisValueAttribute('line', b.line, 1, 255), a += this._analysisValueAttribute('unit', b.unit, 1,
        255); else throw Error('Argument "line / unit" is undefined.'); else throw Error('Argument is undefined.');
    return a + '/>';
};
...
StarWebPrintBuilder.prototype.createLogoElement = function (b) {
    var a = '<logo';
    void 0 != b &&
    (a += this._analysisEnumAttribute('width', b.width, /^(single|double)$/), a += this._analysisEnumAttribute('height', b.height, /^(single|double)$/), a += this._analysisValueAttribute('number',
        b.number, 1, 255));
    return a + '/>';
};
...
StarWebPrintBuilder.prototype.createTextElement = function (b) {
    var a;
    if (void 0 != b) a = '<text' + this._analysisEnumAttribute('emphasis', b.emphasis, /^(false|true)$/), a += this._analysisEnumAttribute('invert', b.invert,
        /^(false|true)$/), a += this._analysisEnumAttribute('linespace', b.linespace, /^(24|32)$/), a += this._analysisEnumAttribute('font', b.font, /^(font_[ab])$/), a += this._analysisEnumAttribute(
        'underline', b.underline, /^(false|true)$/), a += this._analysisValueAttribute('characterspace', b.characterspace, 0, 7), a +=
        this._analysisValueAttribute('width', b.width, 1, 6), a += this._analysisValueAttribute('height', b.height, 1, 6), a += this._analysisEnumAttribute('codepage', b.codepage,
        /^(cp(437|737|772|774|851|852|855|857|858|860|861|862|863|864|865|866|869|874|928|932|998|999|1001|1250|1251|1252|2001|3001|3002|3011|3012|3021|3041|3840|3841|3843|3844|3845|3846|3847|3848)|utf8|blank|utf8|shift_jis|gb18030|gb2312|big5|korea)$/), a += this._analysisEnumAttribute(
        'international', b.international, /^(usa|france|germany|uk|denmark|sweden|italy|spain|japan|norway|denmark2|spain2|latin_america|korea|ireland|legal)$/),
        void 0 != b.data ? (a += '>', a = !0 == b.binary ? a + this._encodeEscapeSequenceBinary(b.data) : a + this._encodeEscapeSequence(b.data), a += '</text>') : a += '/>'; else throw Error(
...
StarWebPrintBuilder.prototype._encodeEscapeSequence = function (b) {
    ...
    a.test(b) && (b = b.replace(a, function (a) {return '\\' == a ? '\\\\' : '\\x' + ('0' + a.charCodeAt(0).toString(16)).slice(-2);}));
    return b;
};
...
StarWebPrintBuilder.prototype._encodeBase64Binary = function (b) {
    var a = '', d = b.length;
    b += '\x00\x00';
    for (var e = 0; e < d; e += 3) var c = b.charCodeAt(e) << 16 | b.charCodeAt(e + 1) << 8 | b.charCodeAt(e + 2), a = a +
...
StarWebPrintBuilder.prototype._encodeRasterImage = function (b, a, d) {
    ...
    a = b.length;
    b += '\x00\x00';
    for (g = 0; g < a; g += 3) d = b.charCodeAt(g) << 16 | b.charCodeAt(g + 1) << 8 | b.charCodeAt(g + 2), c += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(d >> 18 &
        63) + 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(d >> 12 & 63) + 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(d >> 6 & 63) +
