...
StarWebPrintBuilder.prototype._encodeRasterImage = function (b, a, d) {
    for (var e = [
        ...
        for (var h = 0, k = 128, l = 0; l < a; l++)
            if (((30 * b[f] + 59 * b[f + 1] + 11 * b[f + 2]) * b[f + 3] + 12800) / 25500 - b[f + 3] < e[g & 7][l & 7] && (h |= k), f += 4, 0 == (k >>= 1))
    ...
    a = b.length;
    b += '\x00\x00';
    for (g = 0; g < a; g += 3) d = b.charCodeAt(g) << 16 | b.charCodeAt(g + 1) << 8 | b.charCodeAt(g + 2),
        c += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(d >> 18 & 63) +
